...
t[3] = v[3] ;
v[4] = ['PS','FF','GX','DD','TT','TTHA','RH','QQ','NN','LC','CH','PE1','PE3','PE6','VI']
t[4] = ['Mslp','U10m','Max Wind Gust','Wind direction','T2m','T2m, height corr.','Rh2m','Q2m','Cloud cover','Low clouds','Cloud base','1h Precipitation','3h Precipitation','6h Precipitation','Visibility']
v[5] = [0]
v[5] = v[5].reverse()
t[5] = v[5]
v[6] = ['MNWC_preop_MEPS_prodmbr000']
t[6] = ['MNWC_preop_MEPS_prodmbr000']
v[7] = ['ALL'] ;
t[7] = v[7] ;
